...
--Moyenne de points par rencontre depuis le début de la saison
select SUM(POINTS_MARQUES_RENCONTRE)/
...
--Meilleur joueur d'une journée (pour une catégorie)
...
-- nombre de victoire, nuls, défaites par équipe pour un club donné
